...
design_libs=(xil_defaultlib lib_cdc_v1_0_2 proc_sys_reset_v5_0_14)
...
compile()
{
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../verimoog_1_8.gen/sources_1/bd/design_1/ipshared/c2c6" \
