...
design_libs_elab="-libname xil_defaultlib -libname lib_cdc_v1_0_2 -libname proc_sys_reset_v5_0_14 -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xil_defaultlib lib_cdc_v1_0_2 proc_sys_reset_v5_0_14)
...
compile()
{
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../verimoog_1_8.gen/sources_1/bd/design_1/ipshared/c2c6" \
